...
| | |
|---|---|
| **`main` went red TWICE today** | `15b0fb8` (pushed direct, `-Wformat-truncation`) and `b22202b` (a dependabot PR merged over a **failing** check, `cinder-ffi` would not compile). Both fixed here. |
...
|---|---|---|
| `15b0fb8` | pushed directly to `main` | `failure` at 12:25 UTC (§A1) |
| `b22202b` | dependabot PR **#8** merged | `failure` on the PR run for `92fd6b2` (§A5) |
